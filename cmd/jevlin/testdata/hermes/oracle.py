...
FINDINGS: 0.
    ...
    HERMES_DIFFERENTIAL_OUT=/tmp/pairs.json go test ./cmd/jevlin -run TestHermesDifferential -count=1
    python3 cmd/jevlin/testdata/hermes/oracle.py /tmp/pairs.json      # needs PyYAML
"""
import copy
import json
import sys
